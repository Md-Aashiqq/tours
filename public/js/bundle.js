...
var stripe = Stripe('pk_test_51JJB80SDRpM2Qwe5V1DoDfVePuetvBuJBm5pdwplP7o4rHnhoO3k9k0eYqobtg8qugIIF6TYG6VvfmCL25zESsgl00Hw2wsIeC');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log('going'); // 1) Get checkout session from API
